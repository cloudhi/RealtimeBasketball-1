...
public class NbaNewsAdapter extends BaseAdapter {

	private List<NbaNews> newss;
	private Context context;
	private HashMap<String, SoftReference<Bitmap>> hashMap = new HashMap<String, SoftReference<Bitmap>>();

	public NbaNewsAdapter(List<NbaNews> newss, Context context) {
		this.newss = newss;
	...
	public void addAll(List<NbaNews> mDatas) {
		this.newss.addAll(mDatas);
	}

	public void setDatas(List<NbaNews> mDatas) {
		this.newss.clear();
		this.newss.addAll(mDatas);
	}
